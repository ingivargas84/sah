<!-- Modal -->
<div class="modal fade" id="modalUpdateTipoDocumento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <form method="POST" id="TipoDocumentoUpdateForm">
            {{ method_field('put') }}
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" id="ButtonTipoDocumentoModalUpdate" >Actualizar</button>
                </div>
              </div>
            </div>
        </form>
